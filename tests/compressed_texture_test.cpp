...
TEST(CompressedTextureTest, DDS_BC1_Parse) {
    constexpr uint8_t k_dds_bc1[] = {
        0x44, 0x44, 0x53, 0x20, 0x7c, 0x00, 0x00, 0x00, 0x07, 0x10, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
    ...
    static_assert(sizeof(k_dds_bc1) == 4 + 124 + 8, "DDS size mismatch");

    assets::CompressedImage img;
    ASSERT_TRUE(assets::DDSLoader::parse(k_dds_bc1, sizeof(k_dds_bc1), img));
