...
-- 基础亮度整体调高，夜晚/黄昏不再过于昏暗。
local DAY = {
    ambient = { r = 0.95, g = 0.95, b = 1.0, a = 1 }, ai = 0.95,
    sky = { r = 1.0, g = 1.0, b = 1.0, a = 1 },
    sun = { r = 0.85, g = 0.88, b = 1.0, a = 1 }, si = 0.72,
    tint = { r = 1.0, g = 1.0, b = 1.0, a = 1 },
}
local DUSK = {
    ambient = { r = 0.68, g = 0.54, b = 0.60, a = 1 }, ai = 0.80,
    sky = { r = 1.0, g = 0.78, b = 0.60, a = 1 },
    sun = { r = 1.0, g = 0.74, b = 0.52, a = 1 }, si = 0.62,
    tint = { r = 0.97, g = 0.86, b = 0.78, a = 1 },
}
local NIGHT = {
    ambient = { r = 0.34, g = 0.38, b = 0.55, a = 1 }, ai = 0.62,
    sky = { r = 0.12, g = 0.16, b = 0.30, a = 1 },
    sun = { r = 0.55, g = 0.62, b = 1.0, a = 1 }, si = 0.58,
    tint = { r = 0.70, g = 0.74, b = 0.95, a = 1 },
}
local DAWN = {
    ambient = { r = 0.86, g = 0.82, b = 0.88, a = 1 }, ai = 0.88,
    sky = { r = 0.97, g = 0.86, b = 0.80, a = 1 },
    sun = { r = 0.95, g = 0.82, b = 0.68, a = 1 }, si = 0.66,
    tint = { r = 0.98, g = 0.93, b = 0.90, a = 1 },
}
